        ...
        `}>
          {plannerMode && (
            <div className="w-80 h-full overflow-y-auto">
              ...
              {/* No vessel-details section — the Planner stays tight.
                  A marker click still auto-populates the waypoints so
                  the operator sees the vessel's route instantly; for
                  anything else (IMO, cargo, operator) the Open Linkage
                  flow lives on the dashboard card / linkage view. */}
