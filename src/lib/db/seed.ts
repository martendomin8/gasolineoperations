...
async function seed() {
  ...
  const partiesData = [
    // Fixed terminals
    { type: "terminal" as const, name: "Klaipeda Oil Terminal", port: "Klaipeda", email: "ops@klaipeda-terminal.lt", phone: "+370 46 123456", isFixed: true, notes: "Baltic hub. Blending operations available. Max draft 12.5m." },
    { type: "terminal" as const, name: "Vopak Amsterdam", port: "Amsterdam", email: "nominations@vopak-ams.nl", phone: "+31 20 7891234", isFixed: true, notes: "ARA hub. Global gasoline blending center. 24h operations." },
    { type: "terminal" as const, name: "ATPC Antwerp", port: "Antwerp", email: "scheduling@atpc-antwerp.be", phone: "+32 3 5678901", isFixed: true, notes: "ARA hub. Berth allocation requires 72h notice." },
    // Agents
    { type: "agent" as const, name: "Baltic Shipping Agency", port: "Klaipeda", email: "ops@baltic-shipping.lt", phone: "+370 46 654321", isFixed: false, notes: "Preferred agent for Klaipeda operations." },
    { type: "agent" as const, name: "Van Ommeren Agency", port: "Amsterdam", email: "agency@vanommeren.nl", phone: "+31 20 4561234", isFixed: false, notes: "Covers AMS and RTM." },
    { type: "agent" as const, name: "Antwerp Maritime Services", port: "Antwerp", email: "ops@ams-antwerp.be", phone: "+32 3 2345678", isFixed: false, notes: "" },
    // Inspectors
    { type: "inspector" as const, name: "SGS Klaipeda", port: "Klaipeda", email: "petroleum.klaipeda@sgs.com", phone: "+370 46 789012", isFixed: false, notes: "Q&Q inspection. 24h notice for appointment." },
    { type: "inspector" as const, name: "Saybolt Amsterdam", port: "Amsterdam", email: "amsterdam@saybolt.com", phone: "+31 20 6789012", isFixed: false, notes: "Preferred for ARA. Fast turnaround on CoQ." },
    { type: "inspector" as const, name: "Intertek Antwerp", port: "Antwerp", email: "petroleum.antwerp@intertek.com", phone: "+32 3 8901234", isFixed: false, notes: "" },
    // Brokers
    { type: "broker" as const, name: "Clarksons Platou", port: null, email: "chartering@clarksons.com", phone: "+44 20 73341000", isFixed: false, notes: "Primary chartering broker. MR tanker specialist." },
    { type: "broker" as const, name: "Poten & Partners", port: null, email: "tankers@poten.com", phone: "+1 212 2302000", isFixed: false, notes: "Alternative broker for transatlantic." },
  ];
  ...
  const dealsData = [
    // ── ACTIVE (deal entered system, workflow starting) ──────────────────────
    {
      ...
      pricingFormula: "Platts CIF NWE Cargo -$5.00/MT",
    },
    {
      ...
      status: "active" as const,
      assignedOperatorId: operator1.id,
      pricingFormula: "Platts FOB Baltic +$2.50/MT",
    },
    {
