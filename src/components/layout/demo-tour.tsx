  ...
  if (!visible && !state?.running) {
    return (
      <button
        ...
        className="fixed bottom-28 right-6 z-50 flex items-center gap-2.5 px-5 py-3 rounded-full bg-[var(--color-accent)] text-white text-sm font-semibold shadow-lg hover:opacity-90 active:scale-95 transition-all"
      >
